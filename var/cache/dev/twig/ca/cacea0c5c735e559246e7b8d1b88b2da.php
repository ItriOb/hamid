...
class __TwigTemplate_a7524deba02569a4db8cf5ba459aba9e extends Template
{
    private $source;
    private $macros = [];
    ...
    <form method=\"post\">
        ...
        <label for=\"inputLogin\" style=\"margin-bottom: 10px\">Login</label>
        ...
        echo "\" style=\"margin-bottom: 10px\" name=\"login\" id=\"inputLogin\" class=\"form-control\" autocomplete=\"username\" required autofocus>
        ...
        // line 41
        echo "
        <button class=\"btn btn-lg btn-primary\" style=\"margin-top: 10px\" type=\"submit\">
            Sign in
        </button>
            </div>
            </div>
...
";
    ...
    {
        return array (  138 => 41,  132 => 28,  124 => 23,  117 => 18,  109 => 15,  106 => 14,  104 => 13,  101 => 12,  95 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <form method=\"post\">
        ...
        <h1 class=\"h3 mb-3 font-weight-normal\">Please sign in</h1>
        <label for=\"inputLogin\" style=\"margin-bottom: 10px\">Login</label>
        <input type=\"text\" value=\"{{ last_username }}\" style=\"margin-bottom: 10px\" name=\"login\" id=\"inputLogin\" class=\"form-control\" autocomplete=\"username\" required autofocus>
        <label for=\"inputPassword\">Password</label>
        <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control\" autocomplete=\"current-password\" required>
...
{% endblock %}", "security/login.html.twig", "/var/www/html/projet/templates/security/login.html.twig");
    }
}
