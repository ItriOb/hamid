...
class __TwigTemplate_89730c806c6fa7b4dc7edd2db78d9c4d extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    ";
        if ((twig_length_filter($this->env, (isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 6, $this->source); })())) > 0)) {
            // line 7
    ...
    ";
        ...
        <div>
            ...
            ";
        // line 16
        echo twig_include($this->env, $context, "atelier/_form.html.twig", ["button_label" => "Mise à jour"]);
        echo "
            <br>
            <a href=\"";
        // line 18
...
";
    ...
    {
        return array (  117 => 21,  111 => 18,  106 => 16,  97 => 9,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"container \">
        <div>
            ...
            {{ include('atelier/_form.html.twig', {'button_label': 'Mise à jour'}) }}
            <br>
...
{% endblock %}", "atelier/edit.html.twig", "/var/www/html/projet/templates/atelier/edit.html.twig");
    }
}
