 ...
 */
final class Version20230208163613 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE atelier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom_instructeur_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, apprentis_inscrits CLOB DEFAULT NULL --(DC2Type:array)
        , CONSTRAINT FK_E1BB182332C748F0 FOREIGN KEY (nom_instructeur_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
